...
import { CheckCircle2, Circle, Lock, Zap, Gift, BookOpen, Trophy, Target } from 'lucide-react';
  ...
  const [quests] = useState([
    {
      id: '1',
      type: 'main',
      title: 'Master the Calculus Chapter',
      description: 'Complete all lessons, problems, and the final quiz for Chapter 5',
      category: 'Math',
      progress: 75,
      total: 100,
      reward: { xp: 500, badge: 'Calculus Champion' },
      status: 'active',
      difficulty: 'Hard',
      daysLeft: 3,
      icon: '📐',
    },
    {
      id: '2',
      type: 'main',
      title: 'Physics Lab Report Excellence',
      description: 'Write and submit a comprehensive lab report with detailed analysis',
      category: 'Physics',
      progress: 40,
      total: 100,
      reward: { xp: 350, badge: 'Lab Scientist' },
      status: 'active',
      difficulty: 'Medium',
      daysLeft: 5,
      icon: '🔬',
    },
    {
      ...
      description: 'Review 100 flashcards for Biology',
      category: 'Biology',
      progress: 65,
      total: 100,
      reward: { xp: 150 },
    ...
    },
    {
      id: '4',
      type: 'side',
      title: 'Study Streak Warrior',
      description: 'Maintain a 14-day study streak',
      category: 'General',
      progress: 12,
      total: 14,
      reward: { xp: 200, badge: 'Unstoppable' },
      status: 'active',
      difficulty: 'Medium',
      daysLeft: 2,
      icon: '🗡️',
    },
    {
      id: '5',
      type: 'main',
      title: 'Chemistry Equations Mastery',
      description: 'Complete 50 chemical equation problems with 90%+ accuracy',
      category: 'Chemistry',
      progress: 0,
      total: 50,
      reward: { xp: 400, badge: 'Chemist' },
      status: 'locked',
      difficulty: 'Hard',
      daysLeft: 7,
      icon: '⚗️',
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="ml-2 px-3 py-1 bg-[#06D6A0]/20 text-[#06D6A0] rounded-full text-sm font-semibold">
                {sideQuests.filter(q => q.status === 'active').length} Active
              </span>
            </div>
          ...
          <div className="flex gap-3 flex-1">
            ...
            <div className="flex-1">
              <h4 
                ...
                style={{
                  color: isCompleted ? '#ffffff' : (isDarkMode ? '#f9fafb' : '#111827')
                }}
              >
                {quest.title}
              </h4>
